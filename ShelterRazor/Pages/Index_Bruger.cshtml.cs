...
public class Index_Bruger : PageModel
{
    ...
    public void OnGet()
    {
        ...
        _brugere.Add(new Administrator(1, "Sofyane Admin", 12345678, "Sofyane@Shelter.dk"));
        _brugere.Add(new Administrator(2, "Lucas Admin", 87654321, "Lucas@SHelter.dk"));
        _brugere.Add(new Medarbejder(3, "Aleks Medarbejder", 22453267, "Aleks@Shelter.dk"));
