...
builder.Services.AddSingleton<BookingListe>();

bool TestData = true;
List<Blog_opslag> Blog_opslagListe = new List<Blog_opslag>();
if (TestData)
{
    Blog_opslag opslag1 = new Blog_opslag(1, "Blog opslag 1", "Dette er det f�rste blog opslag",new DateTime(2026, 8, 8), "path/to/image1.jpg");
